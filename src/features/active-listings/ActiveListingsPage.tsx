...
const ActiveListingsPage = () => {
    return (
        <section>
            ...
            <div className="bg-white p-4 md:px-10 mb-4 md:rounded-md py-10 flex flex-wrap flex-col md:flex-row md:justify-between gap-4 justify-center items-center sticky top-0 shadow-lg">
